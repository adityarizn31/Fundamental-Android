...
import com.example.latihanretrofit.data.response.CustomerReviewsItem
import com.example.latihanretrofit.data.response.PostReviewResponse
...
//        Bagian ini di dapatkan di EndPoint
